      ...
      <div className="max-w-[1200px] mx-auto p-6">
        <div className="w-full min-h-[calc(100vh-80px)] bg-white rounded-xl shadow-lg overflow-hidden">
          <div className="flex justify-between items-center mb-8">
            <h1 className="text-2xl font-bold bg-gradient-to-r from-violet-500 to-purple-600 bg-clip-text text-transparent">Add a New Account</h1>
            <button
          ...
          <div className="space-y-4 mb-8">
            ...
            <div className="relative">
              ...
              <input type="text" placeholder="Search institutions..." className="w-full pl-10 pr-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-violet-500 transition-all" />
            </div>
          </div>

          <div className="bg-violet-50 p-4 rounded-xl mb-8">
            <div className="flex items-start gap-3">
              <span className="material-symbols-outlined text-violet-500 mt-1">security</span>
              <div>
                <h2 className="font-semibold mb-1">Bank-Grade Security</h2>
                <p className="text-sm text-gray-600">Your data is encrypted and protected using RBI licensed Finvu technology.</p>
              </div>
            </div>
          </div>
          ...
          <button className="w-full bg-gradient-to-r from-violet-500 to-purple-600 text-white py-3 rounded-lg font-semibold hover:shadow-lg transition-all transform hover:-translate-y-0.5">
            Connect Securely
          </button>
        </div>
      </div>
